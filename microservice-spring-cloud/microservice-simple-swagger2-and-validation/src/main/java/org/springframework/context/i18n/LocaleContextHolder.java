...
/**
 * ValidationContext
 * hibernate validator 验证框架会调用 此类的getLocale进行国际化设置<br/>
 * @see org.hibernate.validator 中的配置文件
 * 此类来自于spring-context 4.3.11
 * 这里我们魔改一下 方法 getLocaleContext() 来指定所调用的国际化文件
 */
...
//	}
	...
	/**
	 * 魔改版，这里我们手动指定 locateContext，来验证加载方式
	 * @return
	 */
	public static LocaleContext getLocaleContext() {
//		return new SimpleLocaleContext(Locale.JAPANESE);
		return new SimpleLocaleContext(Locale.SIMPLIFIED_CHINESE);
	}	
