package com.leo.microservice.entity.som.manage.cmd;
...
public class SalesOrderCMD implements Serializable {
    ...
    public String toString() {
        return "SalesOrderInfoCmd [shopCode=" + shopCode + ", createTime=" + createTime + ", paymentStatus=" + paymentStatus + ", sourceTypeValue=" + sourceTypeValue + ", orderDocNo=" + orderDocNo
                + ", pfDocNo=" + pfDocNo + ", memberName=" + memberName + ", receiver=" + receiver + ", doDocNo=" + doDocNo + ", orderType=" + orderType + ", createUser=" + createUser + ", address="
                + address + ", itemNo=" + itemNo + ", skuCode=" + skuCode + ", totalItemQty=" + totalItemQty + ", sellerMemo=" + sellerMemo + ", buyerMemo=" + buyerMemo + ", isNeededInvoiceValue="
                + isNeededInvoiceValue + ", timeType=" + timeType + ", startTime=" + startTime + ", endTime=" + endTime + ", payTime=" + payTime + ", payEndTime=" + payEndTime + "]";
    }
