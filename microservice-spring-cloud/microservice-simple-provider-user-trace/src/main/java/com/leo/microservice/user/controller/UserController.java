...
import com.leo.microservice.user.feign.SomFeignClient;
...
public class UserController {
	...
	@Autowired
	SomFeignClient somFeignClient;
	
	@GetMapping("/trace2/{id}")
	public User trace2(@PathVariable Long id) {
		return somFeignClient.trace3();
	}	
	
	
	@GetMapping("/trace4/{id}")
	public User trace4(@PathVariable Long id) {
		User u = new User();
		u.setId(id);
