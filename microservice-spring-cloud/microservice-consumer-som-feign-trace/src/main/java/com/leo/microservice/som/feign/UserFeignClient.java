...
public interface UserFeignClient {
	...
	@RequestMapping(value = "/trace2/{id}", method = RequestMethod.GET)
	public User trace2(@PathVariable("id") Long id); // 两个坑：1. @GetMapping不支持 2. @PathVariable得设置value
	
	@RequestMapping(value = "/trace4/{id}", method = RequestMethod.GET)
	public User trace4(@PathVariable("id") Long id); // 两个坑：1. @GetMapping不支持 2. @PathVariable得设置value	
